...
const Bb1 = ({route, navigation}) => {
  ...
  return (
    <SafeAreaView
      ...
      <DText text={'Tasks are things that you perform individually. For example, "Reading" is a project, and "reading the first chapter" and "reading the second chapter" are the specific tasks within the project.'}/>
